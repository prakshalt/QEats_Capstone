package com.prakshal.qeats.login;
...
import com.prakshal.qeats.RestaurantsActivity;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(AppController.getInstance().getDefaultSharedPreferences().contains("user_id")){
